...
export default {
  ...
  methods: {
    ...
    handlerClickTreeMenu(value) {
      ...
      if (value.command === Support.TRUNCATE && value.type === Support.TABLE) {
        this.loading.tableTruncate = true
      }
      if (value.command === Support.CLEAN && value.type === Support.TABLE) {
        this.loading.tableClean = true
      }
