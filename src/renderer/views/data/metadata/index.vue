<template>
  <div class="app-container">
        ...
        <el-card v-else class="box-card">
          <div slot="header" class="clearfix">
            ...
            <el-tooltip v-if="treeValue.type === 'Server'" class="item" effect="dark" 
              :content="stringFormat('{0} {1}', [this.$t('common.add'), this.$t('common.database')])" placement="top">
              <el-button class="frp-5" type="primary" size="mini" icon="el-icon-plus" @click="loading.addDatabase = true" />
            </el-tooltip>
            <el-tooltip v-if="treeValue.type === 'Server'" class="item" effect="dark" :content="this.$t('common.infomation')" placement="top">
              <el-button class="frp-5" type="success" size="mini" icon="el-icon-info" @click="loading.serverStatus = true" />
            </el-tooltip>
            <el-tooltip v-if="treeValue.type === 'DataBase'" class="item" effect="dark" 
              :content="stringFormat('{0} {1}', [this.$t('common.delete'), this.$t('common.database')])" placement="top">
              <el-button class="frp-5" type="danger" size="mini" icon="el-icon-delete" @click="loading.deleteDatabase = true" />
            </el-tooltip>
            ...
            <el-tooltip v-if="treeValue.type === 'Table' && treeValue.table !== 'system'" class="item" effect="dark" placement="top"
              :content="stringFormat('{0} {1}', [this.$t('common.delete'), this.$t('common.table')])">
              <el-button class="frp-5" type="text" size="small" icon="el-icon-delete" @click="loading.deleteTable = true" />
            </el-tooltip>
            <el-tooltip v-if="treeValue.type === 'Table'" class="item" effect="dark" content="Table Detail" placement="top">
    ...
    <delete-database :loading="loading.deleteDatabase" :server="treeValue.server" :database="treeValue.database" @close="loading.deleteDatabase = false" />
